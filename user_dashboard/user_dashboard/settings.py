...
SECRET_KEY = 'django-insecure-1fz^u@n-v*1j$bnpz&pu^9ud^-1=!1qet-oz2%qqrgbdxy1wif'
...
ALLOWED_HOSTS = ['user-dashboard-ivja.onrender.com', 'localhost', '127.0.0.1', 'localhost:8000', '127.0.0.1:8000']
